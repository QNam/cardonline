...
<head>
	...
	<link rel="stylesheet" href="http://adminweb.anvui.vn/public/plugins/bootstrap-4.4.1/css/bootstrap.min.css">
	<script src="http://adminweb.anvui.vn/public/plugins/jquery3.4.1/jquery3.4.1.js"></script>
</head>
<body>
	<section class="login">
		<div class="container">
			<div class="row">
				<div class="col-3"></div>
				<div class="col-6">
					<form action="{{ route('DoAdminLogin') }}" id="login" method="POST">
						@csrf
						<h3>Đăng Nhập</h3>
	...
	<script src="http://adminweb.anvui.vn/public/plugins/bootstrap-4.4.1/js/bootstrap.min.js"></script>
