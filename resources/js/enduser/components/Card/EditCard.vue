<template>
    <main>
        <div class="d-none">
            ...
            <img src="/static/icons/icon3.jpg?v=1.2">
            <img src="/static/icons/icon4.jpg?v=1.2">
        </div>
                                ...
                                <div class="row">
                                    <div class="col-6 mb-2">
                                        <a href="javascript:;" 
                                            ...
                                            class="d-block">
                                            <img src="/static/icons/icon3.jpg?v=1.2" class="img-fluid" style="max-height: 328px" alt="">
                                        </a>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <a href="javascript:;" 
                                            ...
                                            class="d-block">
                                            <img src="/static/icons/icon4.jpg?v=1.2" class="img-fluid" style="max-height: 328px" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="qncard mb-4">
                                    ...
                                    <template v-for="link, key in cardContent.links">
                                        <div class="sociallItem mb-4 rounded-3 px-4 py-3 shadow d-flex align-items-center justify-content-between"  
                                            ...
                                            <template>
                                                <img :src="listSocial[link.type].thumb + '?v=1.2'" style="width: 35px; height: 35px" alt="">
                                        ...
                                        <div class="row mt-4">
                                            <template v-for="(social, skey) in listSocial"> 
                                                <a class="col-3 mb-4 cusor-pointer" v-if="social.show" :key="skey" @click.stop="onSelectSocial(skey)">
                                                    <img :src="social.thumb + '?v=1.2'" class="img-fluid" alt="">
                                                </a>
                                            </template>
                                        </div>
                                    </div>
